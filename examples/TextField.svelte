<script>
  ...
  const filename = 'TextField.svelte';
</script>

<div>
  <Examples>
    <Example name="basic-textfield" {filename}>
      <TextField label="Basic" />
    </Example>

    <Example name="dense-textfield" {filename}>
    ...
    <Example name="dense-outlined-textfield" {filename}>
      <TextField label="Outlined dense" outlined dense />
    </Example>
