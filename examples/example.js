...
export const getCssDocs = () =>
  derived(getSource(sozaiSrc), ($source) => {
    ...
    for (const line of styleSrc
      ...
      if (parsed) {
        ...
        const style =
          currentSection.section === 'Typography'
            ? name.includes('size')
              ? `font-size: ${value};`
